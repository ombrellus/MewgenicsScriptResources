...
StatusOnBattleEnd { // Gives the chosen statuses at the end of the battle
    even_if_dead true // Give statuses even if the cat was downed
}
...
Metronome 1 // Cast random spell [TEST se cambiare 1 fa qualcosa]
...
Conditional_DebuffRoll { // Execute if roll is successful (special negative roll?? idk) [TEST]
    odds 0-100%
}
...
Conditional_Speculative {} // boh controlla [TEST] (Else può essere usato per non far calcolare la AI gli avvenimenti (COntrolla special_enemy_abilities.gon))
