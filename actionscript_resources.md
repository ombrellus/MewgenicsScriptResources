...
-- Shakes the screen.
> TODO: verify what the params for this are

`ScreamRing(length: float)`
Creates a shockwave circle effect. Used by Pyrophina and Man in the Moon.

> TODO: check if this also has a second parameter like ScreenShake
